  ...
  void invalidFilePath() {
    RuntimeException ex =
        assertThrows(
            ...
            () ->
                Underlay.fromJSON(
                    Path.of("nonexistent_file_path.json"), READ_RESOURCE_FILE_FUNCTION));
  ...
  void noDataPointers() throws IOException {
    IllegalArgumentException ex =
        assertThrows(
            ...
            () ->
                Underlay.fromJSON(
                    Path.of("config/underlay/NoDataPointers.json"), READ_RESOURCE_FILE_FUNCTION));
    LOGGER.info("expected exception", ex);
  ...
  void noEntities() {
    IllegalArgumentException ex =
        assertThrows(
            ...
            () ->
                Underlay.fromJSON(
                    Path.of("config/underlay/NoEntities.json"), READ_RESOURCE_FILE_FUNCTION));
    LOGGER.info("expected exception", ex);
  ...
  void noPrimaryEntity() {
    IllegalArgumentException ex =
        assertThrows(
            ...
            () ->
                Underlay.fromJSON(
                    Path.of("config/underlay/NoPrimaryEntity.json"), READ_RESOURCE_FILE_FUNCTION));
    LOGGER.info("expected exception", ex);
  ...
  void primaryEntityNotFound() {
    IllegalArgumentException ex =
        assertThrows(
            ...
            () ->
                Underlay.fromJSON(
                    Path.of("config/underlay/PrimaryEntityNotFound.json"),
  ...
  void noBQProjectId() {
    IllegalArgumentException ex =
        assertThrows(
            ...
            () ->
                Underlay.fromJSON(
                    Path.of("config/underlay/NoBQProjectId.json"), READ_RESOURCE_FILE_FUNCTION));
    LOGGER.info("expected exception", ex);
