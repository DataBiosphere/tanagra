 ...
 *
 * <p>-print information about the cause and direct users or administrators to the log file for more
 * information
 *
 * <p>-use a bolder font when printing in the UI (e.g. ERROR in bold red text).
 */
