...
public interface UIDataConverter {
  default void initialize(ApiUnderlayV2 underlay, ApiEntityListV2 entities) {
    // Do nothing. Implementations can override this if they need to use the underlay/entities (e.g.
  ...
  default <T> T deserialize(String uiDataSerialized, Class<T> uiDataClass)
