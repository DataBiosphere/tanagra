...
The GCP project id, which is different from the project number. You can find this in the Cloud Console dashboard. More details in the [GCP documentation](https://cloud.google.com/resource-manager/docs/creating-managing-projects). Required if the [iapGkeJwt](#tanagraauthiapgkejwt] or [iapAppEngineJwt](#tanagraauthiapappenginejwt] flags are set.
...
The GKE backend service id. You can find this in the Cloud Console. More details in the [IAP documentation](https://cloud.google.com/iap/docs/signed-headers-howto#verifying_the_jwt_payload). Required if the [iapGkeJwt](#tanagraauthiapgkejwt] or [iapAppEngineJwt](#tanagraauthiapappenginejwt] flags are set.
...
When true, the service expects a JWT generated by Google IAP running in front of GKE. When this flag is set, you must also define the [GKE backend service id](#tanagraauthgcpbackendserviceid) and the [GCP project id](#tanagraauthgcpprojectid). More details in the [GCP documentation](https://cloud.google.com/iap/docs/signed-headers-howto).
