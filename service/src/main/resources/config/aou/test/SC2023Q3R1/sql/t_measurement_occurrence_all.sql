SELECT
  mo.measurement_id, mo.person_id,
...
JOIN `all-of-us-ehr-dev.SC2023Q3R1.person` AS p ON p.person_id = mo.person_id
LEFT JOIN `all-of-us-ehr-dev.SC2023Q3R1.visit_occurrence` AS vo ON vo.visit_occurrence_id = mo.visit_occurrence_id
LEFT JOIN `all-of-us-ehr-dev.SC2023Q3R1.concept` AS c ON vo.visit_concept_id = c.concept_id
