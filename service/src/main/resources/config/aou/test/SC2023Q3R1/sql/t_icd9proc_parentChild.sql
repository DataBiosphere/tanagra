...
FROM `all-of-us-ehr-dev.SC2023Q3R1.prep_concept_relationship` cr
JOIN `all-of-us-ehr-dev.SC2023Q3R1.prep_concept` c1  ON c1.concept_id = cr.concept_id_1
JOIN `all-of-us-ehr-dev.SC2023Q3R1.prep_concept` c2  ON c2.concept_id = cr.concept_id_2
WHERE
...
FROM `all-of-us-ehr-dev.SC2023Q3R1.prep_concept` p
...
SELECT
  p.concept_id AS parent,
  c.concept_id AS child,
FROM `all-of-us-ehr-dev.SC2023Q3R1.concept` p
LEFT JOIN `all-of-us-ehr-dev.SC2023Q3R1.concept` c
    ON c.vocabulary_id = p.vocabulary_id
