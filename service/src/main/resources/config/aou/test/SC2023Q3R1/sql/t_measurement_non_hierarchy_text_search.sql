...
WHERE (c.domain_id = 'Measurement' AND c.vocabulary_id = 'HCPCS' AND c.standard_concept = 'S')
   OR (c.domain_id = 'Measurement' AND c.vocabulary_id = 'LOINC' AND c.standard_concept = 'S' AND c.concept_class_id = 'Clinical Observation')