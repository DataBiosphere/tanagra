...
FROM `all-of-us-ehr-dev.SC2022Q4R6.concept_relationship` cr
JOIN `all-of-us-ehr-dev.SC2022Q4R6.concept` c1 ON c1.concept_id = cr.concept_id_1
JOIN `all-of-us-ehr-dev.SC2022Q4R6.concept` c2 ON c2.concept_id = cr.concept_id_2
WHERE
