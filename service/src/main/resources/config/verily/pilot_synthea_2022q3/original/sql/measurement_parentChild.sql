...
FROM `verily-tanagra-dev.pilot_synthea_2022q3.concept_relationship` cr
JOIN `verily-tanagra-dev.pilot_synthea_2022q3.concept` c1  ON c1.concept_id = cr.concept_id_1
JOIN `verily-tanagra-dev.pilot_synthea_2022q3.concept` c2  ON c2.concept_id = cr.concept_id_2
WHERE
