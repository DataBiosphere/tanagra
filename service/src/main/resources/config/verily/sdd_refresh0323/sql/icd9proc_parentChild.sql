...
FROM `verily-tanagra-dev.aou_static_prep_useast1.prep_concept_relationship` cr
JOIN `verily-tanagra-dev.aou_static_prep_useast1.prep_concept` c1  ON c1.concept_id = cr.concept_id_1
JOIN `verily-tanagra-dev.aou_static_prep_useast1.prep_concept` c2  ON c2.concept_id = cr.concept_id_2
WHERE
