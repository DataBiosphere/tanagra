...
@Component
public class AccessControl2Service {
  private static final Logger LOGGER = LoggerFactory.getLogger(AccessControl2Service.class);
  private final FineGrainedAccessControl accessControlImpl;

  @Autowired
  @SuppressWarnings("PMD.PreserveStackTrace")
  public AccessControl2Service(AccessControlConfiguration accessControlConfiguration) {
