...
if [[ ${useVerilyUnderlays} ]]; then
  ...
  export TANAGRA_EXPORT_SHARED_GCP_PROJECT_ID=prj-e-mspector-0rh
  export TANAGRA_EXPORT_SHARED_BQ_DATASET_IDS=20250219_Datavant_Aggregated_INDEX
  export TANAGRA_EXPORT_SHARED_GCS_BUCKET_NAMES=vwb-dev-warm-tamarind-6834_dataexplorer-export
