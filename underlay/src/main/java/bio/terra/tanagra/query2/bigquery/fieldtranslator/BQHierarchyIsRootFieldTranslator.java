...
public class BQHierarchyIsRootFieldTranslator implements SqlFieldTranslator {
    ...
    private List<SqlField> buildSqlFields() {
        ITEntityMain indexTable = hierarchyIsRootField.getUnderlay().getIndexSchema().getEntityMain(hierarchyIsRootField.getEntity().getName());
    ...
    private String getFieldAlias() { return NameHelper.getReservedFieldName(FIELD_ALIAS + "_" + hierarchyIsRootField.getHierarchy().getName()); }
