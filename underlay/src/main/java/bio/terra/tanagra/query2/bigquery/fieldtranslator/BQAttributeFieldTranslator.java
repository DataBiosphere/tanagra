...
public class BQAttributeFieldTranslator implements SqlFieldTranslator {
    ...
    public BQAttributeFieldTranslator(AttributeField attributeField) {
        ...
        this.indexTable = attributeField.getUnderlay().getIndexSchema().getEntityMain(attributeField.getEntity().getName());
    }
    ...
    private String getValueFieldAlias() {
        return indexTable.getAttributeValueField(attributeField.getAttribute().getName()).getColumnName();
    }

    private String getDisplayFieldAlias() {
        return indexTable.getAttributeDisplayField(attributeField.getAttribute().getName()).getColumnName();
    }
