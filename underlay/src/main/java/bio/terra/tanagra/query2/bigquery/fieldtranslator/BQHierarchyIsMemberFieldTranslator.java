...
public class BQHierarchyIsMemberFieldTranslator implements SqlFieldTranslator {
    ...
    private List<SqlField> buildSqlFields() {
        ITEntityMain indexTable = hierarchyIsMemberField.getUnderlay().getIndexSchema().getEntityMain(hierarchyIsMemberField.getEntity().getName());
    ...
    private String getFieldAlias() { return NameHelper.getReservedFieldName(FIELD_ALIAS + "_" + hierarchyIsMemberField.getHierarchy().getName()); }
