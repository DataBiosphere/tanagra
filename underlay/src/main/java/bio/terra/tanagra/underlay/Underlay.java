...
public final class Underlay {
  ...
  public static Underlay fromJSON(String underlayFileName) throws IOException {
    ...
    if (entities.get(primaryEntity).getSourceStartDateColumn() == null) {
      throw new InvalidConfigException(
          "For primary entity, sourceStartDateColumn must be set to column that contains birth datetime. This is used to compute age_at_occurrence columns in occurrrence tables.");
    }
