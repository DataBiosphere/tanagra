...
//    assertEquals(
//        "CreateEntityTable indexing job generated", CreateEntityMain.class, job.getClass());
//
//    job = jobStageItr.next().get(0);
//    assertEquals(
//        "DenormalizeEntityInstances indexing job generated",
//        WriteEntityAttributes.class,
//        job.getClass());
//    assertEquals(
...
//            .findFirst();
//    assertTrue("BuildTextSearchStrings indexing job generated",
// buildTextSearchStrings.isPresent());
//
